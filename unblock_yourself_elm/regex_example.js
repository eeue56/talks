...
var Elm = {};
Elm['BadRegexExample'] = Elm['BadRegexExample'] || {};
if (typeof _user$project$BadRegexExample$main !== 'undefined') {
    _user$project$BadRegexExample$main(Elm['BadRegexExample'], 'BadRegexExample', undefined);
}
Elm['RegexExample'] = Elm['RegexExample'] || {};
if (typeof _user$project$RegexExample$main !== 'undefined') {
    _user$project$RegexExample$main(Elm['RegexExample'], 'RegexExample', undefined);
}
